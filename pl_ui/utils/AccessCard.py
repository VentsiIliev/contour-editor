...
from API.shared.user.User import User, Role
...
def create_access_pass_for_user(
    ...
    Args:
        user: User instance from API.shared.user.User
...
def send_access_pass_email(user: User, pkpass_path: str, google_pay_path: str):
    ...
    """
    try:
        from API.shared.email.emailSender import EmailSenderService, get_professional_email_template, get_default_email_config
