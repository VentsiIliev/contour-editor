...
from PyQt6.QtCore import QPoint, Qt, QSize, QEvent, pyqtSignal
...
from pl_ui.localization import TranslationKeys, TranslatableDialog
from pl_ui.Endpoints import GO_TO_LOGIN_POS, START_CONTOUR_DETECTION
...
from pl_ui.ui.windows.login.LoginController import LoginController
from pl_ui.ui.windows.login.LoginTab import LoginTab
from pl_ui.ui.windows.login.QRLoginTab import QRLoginTab
from pl_ui.ui.windows.login.SetupStepsWidget import SetupStepsWidget
from pl_ui.utils.IconLoader import LOGIN_BUTTON, LOGIN_QR_BUTTON, LOGO
from utils.jsonUtils import load_json_file
...
class LoginWindow(TranslatableDialog):
    ...
    def on_tab_changed(self) -> None:
        ...
        if self.tabs.currentIndex() == 1:
            ...
            warning_dialog.cancel_button.setText(self.tr(TranslationKeys.Warning.CANCEL))

            result: int = warning_dialog.exec()
