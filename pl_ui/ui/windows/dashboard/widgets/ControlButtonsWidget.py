...
from GlueDispensingApplication.robot.newRobotService import RobotServiceState
...
class ControlButtonsWidget(TranslatableWidget):
    ...
    def on_system_status_update(self, state) -> None:
        """Handle GlueDispensingApplication state updates"""
        try:
    ...
    def update_button_states(self) -> None:
        ...
        # Handle GlueDispensingApplication states (when robot is not paused)
