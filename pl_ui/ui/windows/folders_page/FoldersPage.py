...
from pl_ui.ui.windows.mainWindow.Folder import FolderWidget, FolderController
...
class FoldersPage(QWidget):
    ...
    def __create_folder(self, ID,folder_name, apps,translate_fn):
        from pl_ui.localization import get_app_translator
...
if __name__ == "__main__":
    import sys
    from pl_ui.ui.windows.mainWindow.WidgetFactory import WidgetType
