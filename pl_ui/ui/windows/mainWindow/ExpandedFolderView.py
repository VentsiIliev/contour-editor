...
from pl_ui.localization.mixins import TranslatableQFrame
from pl_ui.localization import TranslationKeys
from pl_ui.ui.windows.mainWindow.managers.AnimationManager import AnimationManager
