...
from pl_ui.ui.windows.dashboard.DashboardWidget import DashboardWidget
...
class DashboardAppWidget(AppWidget):
    ...
    def setup_ui(self):
        ...
        try:
            from pl_ui.ui.windows.dashboard.DashboardWidget import DashboardWidget
            from pl_ui.Endpoints import UPDATE_CAMERA_FEED
            ...
            self.content_widget.clean_requested.connect(self.clean_requested.emit)
