...
from pl_ui.localization import TranslationKeys, TranslatableWidget, TranslatableDialog
...
class UserManagementWidget(TranslatableWidget):
    ...
    def send_access_package(self, user,qr_image_path):
        ...
        from pl_ui.utils.AccessCard import create_complete_access_package2 , PassConfig
        from pl_ui.utils.IconLoader import LOGO
        from API.shared.email.emailSender import EmailSenderService, get_email_template, get_default_email_config
