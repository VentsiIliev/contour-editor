...
from pl_ui.ui.widgets.SwitchButton import QToggle
...
from GlueDispensingApplication.tools.GlueCell import GlueCellsManagerSingleton, GlueDataFetcher, GlueType
import random
import json
...
class LoadCellsSettingsTabLayout(BaseSettingsTabLayout, QVBoxLayout):
    ...
    def fetch_calibration_config(self, load_cell_id: int):
        from GlueDispensingApplication.tools.GlueCell import GET_CONFIG_ENDPOINT
