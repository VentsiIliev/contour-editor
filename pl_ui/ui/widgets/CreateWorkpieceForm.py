...
from pl_ui.ui.widgets.Drawer import Drawer
from pl_ui.utils.enums.GlueType import GlueType
from pl_ui.utils.enums.Gripper import Gripper
from pl_ui.utils.enums.Program import Program
from pl_ui.utils.enums.ToolID import ToolID
from pl_ui.utils.enums.WorkpieceField import WorkpieceField
from pl_ui.ui.widgets.virtualKeyboard.VirtualKeyboard import FocusLineEdit
from pl_ui.utils.IconLoader import WORKPIECE_ID_ICON_PATH, WORKPIECE_NAME_ICON_PATH, DESCRIPTION_ICON_PATH, OFFSET_ICON_PATH, \
...
class CreateWorkpieceForm(Drawer,QFrame):
    ...
    def apply_stylesheet(self):
        from pl_ui.utils.styles.CreateWorkpieceStyles import getStyles
        styles = getStyles()
    ...
    def add_input_field(self, label, placeholder, icon_path):
        from pl_ui.utils.styles.CreateWorkpieceStyles import get_input_field_styles
    ...
    def add_dropdown_field(self, label, enum_class, icon_path):
        ...
        try:
            from pl_ui.utils.styles.CreateWorkpieceStyles import get_popup_view_styles
